...
window.onload = function init() {
  ...
  ["mozpointerlockchange", "pointerlockchange"].forEach((evt) =>
    document.addEventListener(evt, mouseMove, false)
  );
  ...
  function mouseMove() {
    if (
      ...
      document.addEventListener("mousemove", updateInfos, false);
    } else {
      document.removeEventListener("mousemove", updateInfos, false);
    }
  }
  ...
  document.addEventListener(
    ...
    function (event) {
      if (event.key === "p") {
        !lock ? document.exitPointerLock() : canvas.requestPointerLock();
        lock = !lock;
      }
    },
    true
